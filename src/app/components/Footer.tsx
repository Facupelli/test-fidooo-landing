...
export default function Footer() {
  return (
    <footer className="bg-primary py-[34px] ">
      <div className="max-w-screen-xl mx-auto flex flex-col-reverse place-content-center md:flex md:flex-row md:gap-[180px] md:px-[110px]">
        <div className="">
